...
public class Callback implements org.apache.thrift.TBase<Callback, Callback._Fields>, java.io.Serializable, Cloneable, Comparable<Callback> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Callback");
  ...
  private static final org.apache.thrift.protocol.TField UPDATE_FIELD_DESC = new org.apache.thrift.protocol.TField("update", org.apache.thrift.protocol.TType.I32, (short)4);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CallbackStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CallbackTupleSchemeFactory();

  public CustomPair pair; // required
  public java.lang.String event; // required
  public CallbackType type; // required
  public ValidUpdate update; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.TYPE, new org.apache.thrift.meta_data.FieldMetaData("type", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.ENUM        , "CallbackType")));
    tmpMap.put(_Fields.UPDATE, new org.apache.thrift.meta_data.FieldMetaData("update", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.ENUM        , "ValidUpdate")));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Callback.class, metaDataMap);
  }
  ...
  public Callback(Callback other) {
    if (other.isSetPair()) {
      this.pair = new CustomPair(other.pair);
    }
    if (other.isSetEvent()) {
  ...
  public CustomPair getPair() {
    return this.pair;
  }

  public Callback setPair(CustomPair pair) {
    this.pair = pair;
    return this;
  }
  ...
  public Callback setEvent(java.lang.String event) {
    this.event = event;
    return this;
  }
  ...
  public Callback setType(CallbackType type) {
    this.type = type;
    return this;
  }
  ...
  public ValidUpdate getUpdate() {
    return this.update;
  }

  public Callback setUpdate(ValidUpdate update) {
    this.update = update;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof Callback)
      return this.equals((Callback)that);
    return false;
  }

  public boolean equals(Callback that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    if (isSetUpdate())
      hashCode = hashCode * 8191 + update.getValue();
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Callback(");
    boolean first = true;
  ...
  private static class CallbackStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CallbackStandardScheme getScheme() {
      return new CallbackStandardScheme();
    }
  }

  private static class CallbackStandardScheme extends org.apache.thrift.scheme.StandardScheme<Callback> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Callback struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = thrift.CallbackType.findByValue(iprot.readI32());
          ...
          case 4: // UPDATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.update = thrift.ValidUpdate.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Callback struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.update != null) {
        ...
        oprot.writeI32(struct.update.getValue());
        oprot.writeFieldEnd();
      }
  ...
  private static class CallbackTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CallbackTupleScheme getScheme() {
      return new CallbackTupleScheme();
    }
  }

  private static class CallbackTupleScheme extends org.apache.thrift.scheme.TupleScheme<Callback> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Callback struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Callback struct) throws org.apache.thrift.TException {
